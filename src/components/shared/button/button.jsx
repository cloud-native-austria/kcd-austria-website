...
const styles = {
  base: 'inline-flex items-center justify-center !leading-none text-center whitespace-nowrap rounded transition-all duration-200 outline-none font-bold text-[18px] hover:text-white',
  size: {
