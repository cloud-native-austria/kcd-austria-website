    ...
    <section className="safe-paddings container-md text-center">
      ...
      <div className="mt-3 grid grid-cols-2 md:grid-cols-1 gap-2">
        <div className="flex items-center m-4 ml-4 p-2 relative bg-gray-12 rounded-md">
          <SpeakerProfileImage speakers={workshopSpeakers} speakerId="214b6e38-faf7-4261-a621-c1063ef39bad" className="absolute -left-8 max-h-16 rounded-full cursor-pointer"
            onClick={() => handleImageClick('214b6e38-faf7-4261-a621-c1063ef39bad')} />
