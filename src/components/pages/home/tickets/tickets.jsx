...
import loadWorkshopSessions from '../speakers/loadWorkshopSessions';
import SpeakerModal from '../speakers/speakerModal';
import SessionModal from '../speakers/sessionModal';
    ...
    <section className="safe-paddings container-md text-center">
      ...
      <div className="mt-3 grid grid-cols-2 md:grid-cols-1 gap-2">
        <div className="flex items-center m-4 ml-4 p-2 relative bg-gray-12 rounded-md">
          <SpeakerProfileImage speakers={workshopSpeakers} speakerId={"bed265e5-76db-4a71-9c0d-c91371e85a87"} className="absolute -left-8 max-h-16 rounded-full cursor-pointer" onClick={() => handleImageClick("bed265e5-76db-4a71-9c0d-c91371e85a87")} />
          <div className="pl-10 flex flex-col content-between gap-1 h-full">
            ...
            <div className="flex flex-col gap-1 items-start text-start justify-center h-full">
              <h4 className="text-purple font-bold text-balance cursor-pointer" onClick={() => handleSessionClick("687227")}>Build your own Internal Developer Platform with CNOE</h4>
        ...
        <div className="flex items-center m-4 ml-4 p-2 relative bg-gray-12 rounded-md">
          <div className="absolute -left-8">
            <SpeakerProfileImage speakers={workshopSpeakers} speakerId={"53714b74-4585-446b-99f7-83406937bac8"} className="max-h-16 rounded-t-full cursor-pointer" onClick={() => handleImageClick("53714b74-4585-446b-99f7-83406937bac8")} />
            <SpeakerProfileImage speakers={workshopSpeakers} speakerId={"cb938518-75cf-4ead-9262-f24323657e4c"} className="max-h-16 rounded-b-full cursor-pointer" onClick={() => handleImageClick("cb938518-75cf-4ead-9262-f24323657e4c")} />
          </div>
          <div className="pl-10 flex flex-col content-between gap-1 h-full" >
            ...
            <div className="flex flex-col gap-1 items-start text-start justify-center h-full">
              <h4 className="text-purple font-bold text-balance cursor-pointer" onClick={() => handleSessionClick("701299")}>Detecting unexpected behavior and intrusions with Falco + Atomic Red Team</h4>
        ...
        <div className="flex items-center m-4 ml-4 p-2 relative bg-gray-12 rounded-md">
          <SpeakerProfileImage speakers={workshopSpeakers} speakerId={"1829d862-9dc7-49f7-b290-0f69bf61f7d0"} className="absolute -left-8 max-h-16 rounded-full cursor-pointer" onClick={() => handleImageClick("1829d862-9dc7-49f7-b290-0f69bf61f7d0")} />
          <div className="pl-10 flex flex-col content-between gap-1 h-full">
            ...
            <div className="flex flex-col gap-1 items-start text-start justify-center h-full">
              <h4 className="text-purple font-bold text-balance cursor-pointer" onClick={() => handleSessionClick("712278")}>Deep Dive Into Kubernetes IAM and Network Security: How To Automate at Scale With IBAC and GitOps</h4>
        ...
        <div className="flex items-center m-4 ml-4 p-2 relative bg-gray-12 rounded-md">
          <SpeakerProfileImage speakers={workshopSpeakers} speakerId={"a2665c2b-13c9-4337-9c78-db85bca70e60"} className="absolute -left-8 max-h-16 rounded-full cursor-pointer" onClick={() => handleImageClick("a2665c2b-13c9-4337-9c78-db85bca70e60")} />
          <div className="pl-10 flex flex-col content-between gap-1 h-full">
      ...
      <SpeakerModal isOpen={isSpeakerModalOpen} onClose={closeSpeakerModal} speaker={selectedSpeaker} />
      <SessionModal isOpen={isSessionModalOpen} onClose={closeSessionModal} session={selectedSession} />
    </section >
  );
};
