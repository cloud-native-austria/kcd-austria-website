  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        slide4: 'slide4 10s ease-in-out infinite',
      },
      keyframes: {
        slide1: {
        ...
        slide2: {
          '0%, 20%': { transform: 'translateX(-500px)', opacity: 0 },
          '25%, 45%': { transform: 'translateX(0)', opacity: 1 },
          '50%, 100%': { transform: 'translateX(500px)', opacity: 0 },
        },
        slide3: {
          '0%, 45%': { transform: 'translateX(-500px)', opacity: 0 },
          '50%, 70%': { transform: 'translateX(0)', opacity: 1 },
          '75%, 100%': { transform: 'translateX(500px)', opacity: 0 },
        },
        slide4: {
          '0%, 70%': { transform: 'translateX(-500px)', opacity: 0 },
          '75%, 95%': { transform: 'translateX(0)', opacity: 1 },
